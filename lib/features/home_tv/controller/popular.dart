...
class PopularTvSeriesController extends BaseRepositoryController<HomeTvRepository, HomeTvProvider, TvSeriesWrapper?> {
  ...
  Future<void> _getTvSeries() async {
    ...
    final TvSeriesWrapper? tvSeriesWrapper = await repository.getPopularTvSeries(
